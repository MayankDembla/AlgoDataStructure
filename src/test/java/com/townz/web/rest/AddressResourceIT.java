...
import com.townz.IntegrationTest;
...
class AddressResourceIT {
    ...
    void partialUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.address(UPDATED_ADDRESS).pincode(UPDATED_PINCODE);
    ...
    void fullUpdateAddressWithPatch() throws Exception {
        ...
        partialUpdatedAddress.address(UPDATED_ADDRESS).location(UPDATED_LOCATION).pincode(UPDATED_PINCODE);
