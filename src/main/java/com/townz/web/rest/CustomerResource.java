            ...
            .map(
                existingCustomer -> {
                    ...
                    if (customer.getSphone() != null) {
                        existingCustomer.setSphone(customer.getSphone());
                    }
                    ...
                    if (customer.getIsFirstBooking() != null) {
                        existingCustomer.setIsFirstBooking(customer.getIsFirstBooking());
                    }
                    if (customer.getTimecreated() != null) {
                        existingCustomer.setTimecreated(customer.getTimecreated());
                    }
